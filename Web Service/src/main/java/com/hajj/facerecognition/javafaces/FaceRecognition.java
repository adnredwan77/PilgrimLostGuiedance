...
import com.hajj.facerecognition.javafaces.ValueIndexPair;
...
public class FaceRecognition{
	...
	private double[] getImageData(String imageFileName) throws FaceRecError {
		...
		//bi.getData().getPixels(100, 100, imageWidth, imageHeight,inputFace);
		for (int y=0, nb=0 ; y < imageHeight ; y++)
	        for (int x=0 ; x < imageWidth ; x++, nb++)
	        	inputFace[nb] = bi.getRaster().getSampleDouble(x, y, 0) ;
		}
		return inputFace;
	}	
	...
	public static void main(String[] args){
		...
		String imgToCheck ="C:\\Users\\Abdelrahman\\Documents\\workspace-sts-3.9.0.RELEASE\\OpenCVTest\\lib\\9338454.1.jpg";
		String imgDir = "C:\\Users\\Abdelrahman\\Documents\\workspace-sts-3.9.0.RELEASE\\OpenCVTest\\lib\\faces";
